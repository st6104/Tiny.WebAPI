...
namespace Tiny.MultiTenant.DbContexts.EntityTypeBuilders;

internal class TenantInfoEntityTypeBuilder<TTenantInfo> : IEntityTypeConfiguration<TTenantInfo> where TTenantInfo:class, ITenantInfo
{

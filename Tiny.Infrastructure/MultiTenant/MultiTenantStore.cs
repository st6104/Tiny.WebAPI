...
namespace Tiny.Infrastructure.MultiTenant
{
    public class MultiTenantStore : IMultiTenantStore<TenantInfo>
    {
        ...
        public MultiTenantStore()
        {
            ...
            {
                new TenantInfo("1000", "Tenant1", "Server=tinydb;Database=TinyWebJournal;User Id=sa;Password=wnsdlf83!!;MultipleActiveResultSets=true;Encrypt=false"),
                new TenantInfo("2000", "Tenant2", "Server=tinydb;Database=TinyWebJournal;User Id=sa;Password=wnsdlf83!!;MultipleActiveResultSets=true;Encrypt=false"),
                new TenantInfo("3000", "Tenant3", "Server=tinydb;Database=TinyWebJournal2;User Id=sa;Password=wnsdlf83!!;MultipleActiveResultSets=true;Encrypt=false")
            };
        }

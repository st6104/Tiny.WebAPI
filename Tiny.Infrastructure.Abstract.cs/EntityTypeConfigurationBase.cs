    ...
    public void Configure(EntityTypeBuilder<T> builder)
    {
        ...
        if (entityType.IsImplemented<IHasTenantId>())
        {
            ...
            var filterExpression =
                EFexpression.GetPropertyValueEqualityExpression(entityParamExp, TenantFieldNames.Id, _currentTenant.Id);
        ...
        if (entityType.IsImplemented<ISoftDeletable>())
        {
            ...
            var filterExpression =
                EFexpression.GetPropertyValueEqualityExpression(entityParamExp, nameof(ISoftDeletable.Deleted), false);
            if (filterExpression != null)
            {
                filters.Add(filterExpression);
            }
